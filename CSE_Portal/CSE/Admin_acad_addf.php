...
<div class="col-xs-12 col-lg-12">
  <div class="box-success box view-item col-xs-12 col-lg-12">
    <div class="stu-master-form">
     <p class="note">Fields with <span class="required"> <b style="color:red;">*</b></span> area required.</p>
...
<label class="control-label" for="stuinfo-stu_unique_id">Faculty ID</label><input type="text" min="1" max="50" id="fid" class="form-control" name="f_id" onkeypress="return isNumber(event);" ><div class="help-block" required></div>
</div>    </div>
<div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_first_name">
<label class="control-label" for="stuinfo-stu_first_name">First Name</label><input id="fname" class="form-control" name="first_name" type="text" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>

    
    <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_last_name">
<label class="control-label" for="stuinfo-stu_last_name">Last Name</label><input id="lname" class="form-control" name="last_name" type="text" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>
    </div>
...
<label class="control-label" for="stuinfo-stu_email_id">Degree</label><input id="deg" class="form-control" name="degree" maxlength="60" type="text" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>
    <div class="col-xs-12 col-sm-4 col-lg-4">
	<div class="form-group field-stuinfo-stu_mobile_no ">
<label class="control-label" for="stuinfo-stu_mobile_no">Degree Field</label><input id="deg_field" class="form-control" name="degree_field" maxlength="20" type="text" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>
   </div>
...
<label class="control-label" for="stumaster-stu_master_category_id">E-mail</label><input id="email" class="form-control" type="email" name="email" >
<div class="help-block"></div>
</div>	</div> 
	<div class="col-xs-12 col-sm-4 col-lg-4">
		<div class="form-group field-stumaster-stu_master_nationality_id">
<label class="control-label" for="stumaster-stu_master_nationality_id">Address</label><input id="addr" class="form-control" name="address" onkeypress="return isCity(event);" >
<div class="help-block"></div>
</div>	</div>
<div class="col-xs-12 col-sm-4 col-lg-4">
        <div class="form-group field-stumaster-stu_master_nationality_id">
<label class="control-label" for="stumaster-stu_master_nationality_id">City</label><input id="city" class="form-control" name="city" onkeypress="return isName(event);" >
<div class="help-block"></div>
</div>  </div> 
<div class="col-xs-12 col-sm-4 col-lg-4">
    <div class="form-group field-stumaster-stu_master_nationality_id">
<label class="control-label" for="stumaster-stu_master_nationality_id">State</label><input id="state" class="form-control" name="state" onkeypress="return isName(event);" >
<div class="help-block"></div>
</div>  </div>
<div class="col-xs-12 col-sm-4 col-lg-4">
<div class="form-group field-stumaster-stu_master_nationality_id">
<label class="control-label" for="stumaster-stu_master_nationality_id">Pin</label><input id="pin" class="form-control" name="pin" onkeypress="return isNumber(event);" >
<div class="help-block"></div>
</div>  </div>
<div class="col-xs-12 col-sm-4 col-lg-4">
        <div class="form-group field-stumaster-stu_master_nationality_id">
