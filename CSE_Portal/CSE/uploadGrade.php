...
<script type="text/javascript">
	...
	//alert("getCourses.php?acadyear="+ acadyear +"&Semester="+Semester+"&fid=" +id);	
	...
	xml.open("GET","getCourses.php?acadyear="+ acadyear +"&Semester="+Semester+"&fid="+id,true);
...
<div class="pace-activity"></div></div>
        ...
        <ul class="breadcrumb"><li><a href="faculty_profile.php"><i class="fa fa-dashboard"></i> Home</a></li>
...
<td><select class="form-control" id="Semester" name="Semester" onchange="getCourses();">
