...
$(function () {
  $('[data-toggle="popover"]').popover({placement: function() { return $(window).width() < 768 ? 'bottom' : 'right'; }})
   ...
   <div class="stu-master-form">
      ...
      <form id="stu-master-form" action="certificate_request.php" method="post" >
...
<!--<input name="_csrf" value="Z29ncDZCWDFTOjY0Ry9tASw2Fz1vOGF6JTkkFAIoD2g.HQQ7VBIbdQ==" type="hidden"> -->   
              ...
              <div class="box box-solid box-info col-xs-12 col-lg-12 no-padding">
	            ...
	            <div class="col-xs-12 col-sm-4 col-lg-4">
                  ...
                  <div class="col-xs-9 col-sm-4">
    <div class="form-group field-stuinfo-stu_unique_id required">
<label class="control-label" for="stuinfo-stu_unique_id">Purpose Of Certificate</label>
...
<div class="help-block"></div>
	...
	<div class="col-xs-6">
	    <a class="btn btn-block btn-warning" href="student.php">Cancel</a>	</div>
    </div>
<div class="col-xs-2">
