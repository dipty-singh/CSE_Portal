...
<div class="box box-default">
	<div class="box-header with-border">
		<h3 class="box-title"><i class="glyphicon glyphicon-dashboard"></i> Application</h3>
	</div>
	<div class="box-body">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
		      <div class="edusec-link-box">
		        ...
		        <div class="edusec-link-box-content">
		          <span class="edusec-link-box-text"><a href="?controller=student&action=reqforrebate">Request For Leave</a></span>
