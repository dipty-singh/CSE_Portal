...
<label class="control-label" for="stuinfo-stu_first_name" required>Student ID</label><input type="text" id="stuinfo-stu_first_name" name="resource_id" class="form-control" required ><div class="help-block"></div>
</div>    </div>
...
<label class="control-label" for="stuinfo-stu_dob">Type of Resource </label><input type="text" name="resource_name" required class="form-control" >
</div>
</div>
   ...
   <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
    <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_first_name required">
<label class="control-label" for="stuinfo-stu_first_name" required>Date</label><input type="date"  name="purchase_date" class="form-control" required ><div class="help-block"></div>
</div>    </div>
   ...
   <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
    <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_first_name required">
<label class="control-label" for="stuinfo-stu_first_name" required>Period</label><input type="text" id="stuinfo-stu_first_name" name="warranty_period" class="form-control" required ><div class="help-block"></div>
</div>    </div>
