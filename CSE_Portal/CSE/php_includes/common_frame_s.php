...
if($_SESSION['userType'] == 'admin'){
    // $img = 'img/profile/admin/'.$_SESSION['userid'] . '.jpg';
     ...
     $img1 = 'img/profile/student/'.$_SESSION['userid'] . '.png';
     if(file_exists ( $img1 )){
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta name="csrf-token" content="TVMxNURoTUUdBl54LDd6LQ48CUcAPy82fhdWdzAxPiYfKUcGMSo8Jw==">
        <title>Aravali College CSE Dept Portal</title>
...
<a class="logo" href="home.php"><!--img src="img/edusec.png" alt="" height="22px" width="120px;"--><h3>ACEM</h3></a>
    ...
    <li class="dropdown user user-menu">
        ...
        <ul class="dropdown-menu" style="margin-right:10px">
            ...
            <li class="user-header bg-light-blue">
                <img src="img/profile/faculty/unknown.png" class="img-circle" alt="User Image">
		    ...
		    <a class="btn btn-default btn-flat" href="Admin Dashboard.htm" style="font-size:13px">View Profile</a>                
            </div>
            </li>
            <!-- Menu Footer-->
            <li class="user-footer">
                <div class="pull-left">
		    <a class="btn btn-default btn-flat" href="changePassword.php" style="font-size:12px">Change Password</a>                
            </div>
                <div class="pull-right">
                    <a class="btn btn-default btn-flat" href="logout.php" style="font-size:12px">Sign out</a>                
                    </div>
            </li>
        </ul>
