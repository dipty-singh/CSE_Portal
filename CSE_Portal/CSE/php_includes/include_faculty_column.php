...
<!--button><a href='logout.php'>Logout</a></button-->
    ...
    <section class="sidebar">
                ...
                <div class="">
                    <img src="img/profile/faculty/unknown.jpg" class="img-circle" alt="User Image">
                </div>
        ...
        <ul class="sidebar-menu">
            ...
            <!-- <li><a href="Attendance-System-master/teacher.php"><i class="fa fa-book"></i> <span>Attendance</span></a></li> -->
	        </ul>
