...
function isCity(evt) {
  ...
  if ((evt.keyCode >= 65 && evt.keyCode <= 90) || (evt.keyCode >= 97 && evt.keyCode <= 122) || evt.charCode >= 48 && evt.charCode <= 57 || evt.keyCode == 32) {
    return true;
  }
  else {
    return false;
...
<label class="control-label" for="stuinfo-stu_unique_id">Student ID</label><input type="text" id="sid" class="form-control" name="sid" value=" " min="0" onkeypress="return isNumber(event);" max="500" pattern="[0-9.]+" required><div class="help-block"></div>
</div>    </div> 
...
<label class="control-label" for="stuinfo-stu_first_name">First Name</label><input type="text" id="first_name" class="form-control" name="first_name" onkeypress="return isName(event);" pattern="/^[a-zA-Z]+$/" required >
...
<label class="control-label" for="stuinfo-stu_last_name">Last Name</label><input type="text" id="last_name" class="form-control" name="last_name" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>
   </div>

  <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_last_name required">
<label class="control-label" for="stuinfo-stu_last_name">Father Name</label><input type="text" id="father_name" class="form-control" name="father_name" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>
   </div>

  <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_last_name required">
<label class="control-label" for="stuinfo-stu_last_name">Mother Name</label><input type="text" id="mother_name" class="form-control" name="mother_name" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>
   </div>
...
<label class="control-label" for="stuinfo-stu_mobile_no">Mobile No</label><input type="number" id="s_mob_no" class="form-control" name="s_mob_no" minlength="10" maxlength="10"><div class="help-block"></div>
</div>    </div>
</div>   

    <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_guardian_email">
<label class="control-label" for="stuinfo-stu_guardian_email">Guardian Email</label><input type="email" id="guardian_email" class="form-control" name="guardian_email" maxlength="60"><div class="help-block"></div>
</div> 
   </div>
...
<label class="control-label" for="stuinfo-stu_address">Address</label><input type="address" id="address" class="form-control" name="address" onkeypress="return iscity(event);" ><div class="help-block"></div>
</div>    
</div>
   </div>
...
<label class="control-label" for="stuinfo-stu_city">City</label><input type="text" id="city" class="form-control" name="city" onkeypress="return isName(event);" ><div class="help-block" ></div>
</div>    </div>
   
 <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_pin_code required">
<label class="control-label" for="stuinfo-stu_pin_code">Pin Code</label><input type="text" maxlength="6" id="pin_code" onkeypress="return isNumber(event);" class="form-control" name="pin_code"><div class="help-block"></div>
</div>    </div>
...
<label class="control-label" for="stuinfo-stu_state">State</label><input type="text" id="state" class="form-control" name="state" onkeypress="return isName(event);" ><div class="help-block"></div>
</div>    </div>
