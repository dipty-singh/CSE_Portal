    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="home.php">ACEM</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                if(isset($_SESSION["userid"]) && isset($_SESSION["password"]) && isset($_SESSION["userType"]) || isset($_COOKIE["id"]) && isset($_COOKIE["password"]) && isset($_COOKIE["userType"])) {
                 ...
                 ?>
                    ...
                    <li>
                        <a href="https://www.acem.edu.in" target="_blank">Visit Our Website</a>
                    </li>
                    ...
                    <!--          Modal Body And  Main Form Container-->
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <label>In case you forgot password contact <a href="mailto:dipty.singh@acem.edu.in">admin</a></label>
